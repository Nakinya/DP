...
public class EnemyAttackState : IEnemyState
{
    ...
    public EnemyAttackState(EnemyFSMSystem enemyFSMSystem, ICharacter character) : base(enemyFSMSystem, character)
    {
        mStateId = EnemyStateId.AttackState;
    ...
    public override void Reason(List<ICharacter> targets)
    {
        if (targets == null || targets.Count == 0)
        {
            ...
            mFSM.PerformTransition(EnemyTransition.NoSoldierInsight);
        }
        else
        {
